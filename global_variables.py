...
__base_dir = r'D:\Desktop\shishuai.yan\Desktop\git_code\tf_keras_classifier\imgs\clear_2_source'
train_dir = os.path.join(__base_dir, 'train')
valid_dir = os.path.join(__base_dir, 'valid')
checkpoint_path = os.path.abspath('./output/training_5/model-{epoch:04d}.ckpt')
